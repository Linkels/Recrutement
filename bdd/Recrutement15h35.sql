...
-- Généré le :  Mar 14 Mai 2019 à 15:35
...
--
-- Structure de la table `infos-promo`
--

CREATE TABLE `infos-promo` (
  `idip` int(11) NOT NULL,
  `nompromo` varchar(10) NOT NULL,
...
--
-- Contenu de la table `infos-promo`
--

INSERT INTO `infos-promo` (`idip`, `nompromo`, `datecandidature`, `datedebutpromo`, `datefinpromo`) VALUES
...
--
-- Index pour la table `infos-promo`
--
ALTER TABLE `infos-promo`
...
--
-- AUTO_INCREMENT pour la table `infos-promo`
--
ALTER TABLE `infos-promo`
