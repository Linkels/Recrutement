  ...
  <div id="idjury" class="modal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="container">
          <form id="form-modal" action="../validation/validation-jury.php?vall="<?php $id02; ?> method="POST">
            <?php
              //$id2 = $_GET['val'];
  ...
  <div id="idadmin" class="modal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="container">
          <form id="form-modal" action="../validation/validation-admin.php" method="POST">
