...
<body>
  ...
  <form id="form" action="back/validation-update-form.php" enctype="multipart/form-data" method="POST">
...
<!--2ème champ de formulaire-->
    ...
    <fieldset class="champ2">
      ...
      <?php if (isset($resultat['diplome_etudiant']) && $resultat['diplome_etudiant']=="sans") echo "checked";?> value="sans"enctype="multipart/form-data">Sans diplôme<br/>
      ...
      <input type="radio" name="diplome_etudiant" class="radio"
      <?php if (isset($resultat['diplome_etudiant']) && $resultat['diplome_etudiant']=="master") echo "checked";?> value="masenctype="multipart/form-data"ter">Master<br/>
      ...
      <fieldset class="champ2">
          <legend>Votre photo<span class="clr">*</span></legend>
